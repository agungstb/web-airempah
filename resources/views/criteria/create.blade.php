            ...
            <div class="col-xl">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.criteria.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-5">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="criteria"><code>*</code> Criteria</label>
                                        <input type="text" class="form-control @error('criteria') is-invalid @enderror"  name="criteria" value="{{ old('criteria') }}">
                                        @error('criteria')

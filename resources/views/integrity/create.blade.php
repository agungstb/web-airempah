            ...
            <div class="col-xl">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.integrity.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-5">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="alias"><code>*</code> Alias</label>
                                        <input type="text" class="form-control @error('alias') is-invalid @enderror"  name="alias" value="{{ old('alias') }}">
                                        @error('alias')
